...
data class Scenario(
    ...
    val theoryBriefing: String?,
    val passingTips: String?,
    ...
    companion object {
        fun from(o: JSONObject) = Scenario(
            ...
            theoryBriefing = o.optString("theory_briefing").ifBlank { null },
            passingTips = o.optString("passing_tips").ifBlank { null },
